// Message Board State mit $state()
let messages = $state([])
let isOpen = $state(false)
let nextId = 1

export const addMessage = (content, type = 'info', duration = 5000) => {
	const message = {
		id: nextId++,
		content,
...
export const success = (content, duration) =>
	addMessage(content, 'success', duration)
export const error = (content, duration) =>
	addMessage(content, 'error', duration)
export const warning = (content, duration) =>
	addMessage(content, 'warning', duration)
export const info = (content, duration) => addMessage(content, 'info', duration)
